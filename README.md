...
Finally their are also some issues with displaying on different sized screens, which I need to add some media queries for. This is in my current backlog to resolve. 
